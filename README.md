...
- North Star Creative Co. acquisition system at `/northstar-creative`: `Grow Your Business with North Star Creative Co.`, provider signup growth question, business-size classification, richer marketing intake, Forge Marketing Score, lead classifications, service packages, roofing-company marketing subsection, admin lead table, CSV export, follow-up queue integration, and webhook/schema mapping with `northstar_creative` plus `northstar_marketing_operations`
