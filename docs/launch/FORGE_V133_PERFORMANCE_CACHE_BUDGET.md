...
| --- | ---: | --- |
| index.html | 339,005 | Large legacy single-shell architecture; no unbounded growth |
| styles.css | 303,355 | One consolidated token layer; avoid duplicate override systems |
| app.js | 1,129,224 | Dependency-free legacy shell; new work should be route-aware or extracted |
