...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v128")],
  ["html asset version", contents["index.html"].includes("styles.css?v=128") && contents["index.html"].includes("app.js?v=128")]
];
