...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v113")],
  ["html asset version", contents["index.html"].includes("styles.css?v=113") && contents["index.html"].includes("app.js?v=113")]
];
