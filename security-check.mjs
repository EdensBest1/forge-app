...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v70")],
  ["html asset version", contents["index.html"].includes("styles.css?v=70") && contents["index.html"].includes("app.js?v=70")]
];
