...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v86")],
  ["html asset version", contents["index.html"].includes("styles.css?v=86") && contents["index.html"].includes("app.js?v=86")]
];
