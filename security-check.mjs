...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v125")],
  ["html asset version", contents["index.html"].includes("styles.css?v=125") && contents["index.html"].includes("app.js?v=125")]
];
