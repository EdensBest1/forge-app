...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v103")],
  ["html asset version", contents["index.html"].includes("styles.css?v=103") && contents["index.html"].includes("app.js?v=103")]
];
