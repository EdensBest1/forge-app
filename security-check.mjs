...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v119")],
  ["html asset version", contents["index.html"].includes("styles.css?v=119") && contents["index.html"].includes("app.js?v=119")]
];
