...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v99")],
  ["html asset version", contents["index.html"].includes("styles.css?v=99") && contents["index.html"].includes("app.js?v=99")]
];
