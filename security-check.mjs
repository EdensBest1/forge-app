...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v87")],
  ["html asset version", contents["index.html"].includes("styles.css?v=87") && contents["index.html"].includes("app.js?v=87")]
];
