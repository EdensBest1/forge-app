...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v74")],
  ["html asset version", contents["index.html"].includes("styles.css?v=74") && contents["index.html"].includes("app.js?v=74")]
];
