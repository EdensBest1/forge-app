...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v115")],
  ["html asset version", contents["index.html"].includes("styles.css?v=115") && contents["index.html"].includes("app.js?v=115")]
];
