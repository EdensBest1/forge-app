...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v120")],
  ["html asset version", contents["index.html"].includes("styles.css?v=120") && contents["index.html"].includes("app.js?v=120")]
];
