...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v100")],
  ["html asset version", contents["index.html"].includes("styles.css?v=100") && contents["index.html"].includes("app.js?v=100")]
];
