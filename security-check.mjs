...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v73")],
  ["html asset version", contents["index.html"].includes("styles.css?v=73") && contents["index.html"].includes("app.js?v=73")]
];
