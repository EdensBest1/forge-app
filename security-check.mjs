...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v123")],
  ["html asset version", contents["index.html"].includes("styles.css?v=123") && contents["index.html"].includes("app.js?v=123")]
];
