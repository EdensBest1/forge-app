...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v129")],
  ["html asset version", contents["index.html"].includes("styles.css?v=129") && contents["index.html"].includes("app.js?v=129")]
];
