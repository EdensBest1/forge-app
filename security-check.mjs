...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v84")],
  ["html asset version", contents["index.html"].includes("styles.css?v=84") && contents["index.html"].includes("app.js?v=84")]
];
