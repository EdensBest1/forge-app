...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v97")],
  ["html asset version", contents["index.html"].includes("styles.css?v=97") && contents["index.html"].includes("app.js?v=97")]
];
