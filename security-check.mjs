...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v94")],
  ["html asset version", contents["index.html"].includes("styles.css?v=94") && contents["index.html"].includes("app.js?v=94")]
];
