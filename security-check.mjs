...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v116")],
  ["html asset version", contents["index.html"].includes("styles.css?v=116") && contents["index.html"].includes("app.js?v=116")]
];
