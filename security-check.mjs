...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v114")],
  ["html asset version", contents["index.html"].includes("styles.css?v=114") && contents["index.html"].includes("app.js?v=114")]
];
