...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v127")],
  ["html asset version", contents["index.html"].includes("styles.css?v=127") && contents["index.html"].includes("app.js?v=127")]
];
