...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v76")],
  ["html asset version", contents["index.html"].includes("styles.css?v=76") && contents["index.html"].includes("app.js?v=76")]
];
