...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v124")],
  ["html asset version", contents["index.html"].includes("styles.css?v=124") && contents["index.html"].includes("app.js?v=124")]
];
