...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v111")],
  ["html asset version", contents["index.html"].includes("styles.css?v=111") && contents["index.html"].includes("app.js?v=111")]
];
