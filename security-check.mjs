...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v90")],
  ["html asset version", contents["index.html"].includes("styles.css?v=90") && contents["index.html"].includes("app.js?v=90")]
];
