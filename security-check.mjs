...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v107")],
  ["html asset version", contents["index.html"].includes("styles.css?v=107") && contents["index.html"].includes("app.js?v=107")]
];
