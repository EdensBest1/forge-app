...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v132")],
  ["html asset version", contents["index.html"].includes("styles.css?v=132") && contents["index.html"].includes("app.js?v=132")]
];
