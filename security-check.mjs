...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v105")],
  ["html asset version", contents["index.html"].includes("styles.css?v=105") && contents["index.html"].includes("app.js?v=105")]
];
