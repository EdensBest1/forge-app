...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v98")],
  ["html asset version", contents["index.html"].includes("styles.css?v=98") && contents["index.html"].includes("app.js?v=98")]
];
