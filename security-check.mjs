...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v110")],
  ["html asset version", contents["index.html"].includes("styles.css?v=110") && contents["index.html"].includes("app.js?v=110")]
];
