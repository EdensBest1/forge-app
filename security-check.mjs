...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v117")],
  ["html asset version", contents["index.html"].includes("styles.css?v=117") && contents["index.html"].includes("app.js?v=117")]
];
