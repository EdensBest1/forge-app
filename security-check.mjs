...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v96")],
  ["html asset version", contents["index.html"].includes("styles.css?v=96") && contents["index.html"].includes("app.js?v=96")]
];
