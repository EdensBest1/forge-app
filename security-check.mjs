...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v112")],
  ["html asset version", contents["index.html"].includes("styles.css?v=112") && contents["index.html"].includes("app.js?v=112")]
];
