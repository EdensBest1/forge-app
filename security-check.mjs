...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v122")],
  ["html asset version", contents["index.html"].includes("styles.css?v=122") && contents["index.html"].includes("app.js?v=122")]
];
