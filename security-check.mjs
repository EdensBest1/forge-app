...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v131")],
  ["html asset version", contents["index.html"].includes("styles.css?v=131") && contents["index.html"].includes("app.js?v=131")]
];
