...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v104")],
  ["html asset version", contents["index.html"].includes("styles.css?v=104") && contents["index.html"].includes("app.js?v=104")]
];
