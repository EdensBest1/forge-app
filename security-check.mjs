...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v95")],
  ["html asset version", contents["index.html"].includes("styles.css?v=95") && contents["index.html"].includes("app.js?v=95")]
];
