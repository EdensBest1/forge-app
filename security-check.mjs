...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v106")],
  ["html asset version", contents["index.html"].includes("styles.css?v=106") && contents["index.html"].includes("app.js?v=106")]
];
