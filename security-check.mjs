...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v92")],
  ["html asset version", contents["index.html"].includes("styles.css?v=92") && contents["index.html"].includes("app.js?v=92")]
];
