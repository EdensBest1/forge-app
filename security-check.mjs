...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v118")],
  ["html asset version", contents["index.html"].includes("styles.css?v=118") && contents["index.html"].includes("app.js?v=118")]
];
