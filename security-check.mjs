...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v89")],
  ["html asset version", contents["index.html"].includes("styles.css?v=89") && contents["index.html"].includes("app.js?v=89")]
];
