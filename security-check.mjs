...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v108")],
  ["html asset version", contents["index.html"].includes("styles.css?v=108") && contents["index.html"].includes("app.js?v=108")]
];
