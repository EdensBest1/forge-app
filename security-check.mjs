...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v85")],
  ["html asset version", contents["index.html"].includes("styles.css?v=85") && contents["index.html"].includes("app.js?v=85")]
];
