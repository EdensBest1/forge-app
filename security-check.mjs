...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v91")],
  ["html asset version", contents["index.html"].includes("styles.css?v=91") && contents["index.html"].includes("app.js?v=91")]
];
