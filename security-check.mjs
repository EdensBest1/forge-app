...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v83")],
  ["html asset version", contents["index.html"].includes("styles.css?v=83") && contents["index.html"].includes("app.js?v=83")]
];
