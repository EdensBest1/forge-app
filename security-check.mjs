...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v121")],
  ["html asset version", contents["index.html"].includes("styles.css?v=121") && contents["index.html"].includes("app.js?v=121")]
];
