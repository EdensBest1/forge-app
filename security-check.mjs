...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v93")],
  ["html asset version", contents["index.html"].includes("styles.css?v=93") && contents["index.html"].includes("app.js?v=93")]
];
