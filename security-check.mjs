...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v82")],
  ["html asset version", contents["index.html"].includes("styles.css?v=82") && contents["index.html"].includes("app.js?v=82")]
];
