...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v126")],
  ["html asset version", contents["index.html"].includes("styles.css?v=126") && contents["index.html"].includes("app.js?v=126")]
];
