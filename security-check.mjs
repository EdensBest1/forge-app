...
const checks = [
  ...
  ["fresh cache version", contents["service-worker.js"].includes("forge-mvp-v109")],
  ["html asset version", contents["index.html"].includes("styles.css?v=109") && contents["index.html"].includes("app.js?v=109")]
];
