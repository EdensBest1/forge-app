...
const staticChecks = [
  ...
  ["road rescue entrypoint", manifest.entrypoints.roadRescue === "/road-rescue?v=70"],
  ...
  ["forge capital entrypoint", manifest.entrypoints.forgeCapital === "/forge/capital?v=70"],
  ["forge flex alias", manifest.entrypoints.forgeFlex === "/forge/flex?v=70"],
  ["partners flex alias", manifest.entrypoints.partnersFlex === "/partners/flex?v=70"],
  ["building entrypoint", manifest.entrypoints.building === "/building?v=70"],
  ["admin building leads entrypoint", manifest.entrypoints.adminBuildingLeads === "/admin/building-leads?v=70"],
