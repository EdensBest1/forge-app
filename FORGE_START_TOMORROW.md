...
- Home: `http://127.0.0.1:4174/?v=114#home`
- Perspective Demo: `http://127.0.0.1:4174/?v=114#perspective`
- Training & Careers: `http://127.0.0.1:4174/?v=114#opportunities`
- Forge Auto & Transport: `http://127.0.0.1:4174/auto?v=114`
- Admin Auto Ops / Operations Vault: `http://127.0.0.1:4174/?v=114&demo=admin#admin`
...
```text
http://127.0.0.1:4174/?v=114#perspective
```
...
Forge v114 is a local static MVP. It is good for controlled demos and early signup conversations. It is not ready for broad public launch until the remaining gates are finished:
...
```text
This chat is for Forge. Please open /Users/andrewoommern/Documents/Codex/2026-06-14/this-chat-is-for-forge/FORGE_START_TOMORROW.md and FORGE_NEXT_CHAT_HANDOFF.md, then continue from the v114 Forge MVP. Keep building toward tomorrow's soft launch, preserve existing work, run npm run check after code changes, and keep the wireframe style: white, Forge orange, and strong blue.
```
